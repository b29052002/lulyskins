        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <nav className="hidden md:flex items-center space-x-6 text-sm font-semibold">
              ...
              <a href="https://twitch.tv" target="_blank" className="flex items-center space-x-2 text-gray-400 hover:text-white transition">
                <MessageCircle className="w-4 h-4" />
                <span>TWITCH</span>
              </a>
              <a href="https://youtube.com" target="_blank" className="flex items-center space-x-2 text-gray-400 hover:text-white transition">
                <Youtube className="w-4 h-4" />
                <span>YOUTUBE</span>
              </a>
              <a href="https://wa.me" target="_blank" className="flex items-center space-x-2 text-gray-400 hover:text-white transition">
                <MessageCircle className="w-4 h-4" />
                <span>WHATSAPP</span>
              </a>
        ...
        <div className="container mx-auto relative">
          <div className="text-center mb-8">
            ...
            <div className="flex justify-center space-x-6 mt-6">
              <a href="https://twitch.tv" target="_blank" className="text-blue-400 hover:text-blue-300 transition">
                <MessageCircle className="w-6 h-6" />
              </a>
              <a href="https://instagram.com" target="_blank" className="text-blue-400 hover:text-blue-300 transition">
              ...
              <a href="https://twitter.com" target="_blank" className="text-blue-400 hover:text-blue-300 transition">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
