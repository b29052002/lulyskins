...
import { createPageUrl } from "../components/utils"; // ✅ CORRIGIDO
  ...
  const handlePurchase = async () => {
    ...
    try {
      const sale = await createSaleMutation.mutateAsync({
        ...
        total_amount: totalAmount, // ✅ CORRIGIDO - era payment_amount
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link to={createPageUrl("Raffles")} className="text-purple-400 hover:text-purple-300">
            ← Voltar para rifas
          </Link>
        </div>
      </div>
    ...
    >
      ...
      <header className="bg-[#0d1130] border-b border-blue-900/30 sticky top-0 z-50 relative">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <Link to={createPageUrl("Raffles")} className="text-blue-300 hover:text-white transition font-semibold">
            ← Voltar
          </Link>
        </div>
      </header>
                ...
                <div className="bg-green-600/10 border border-green-500/30 rounded-xl p-6">
                  ...
                  {raffle.winner_number != null ? (
                    <>
                      ...
                      <p className="text-white text-xl mb-2">{raffle.winner_name || "Não informado"}</p>
